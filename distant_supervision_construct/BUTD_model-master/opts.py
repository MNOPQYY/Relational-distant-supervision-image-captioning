...
def parse_opt():
    ...
    parser.add_argument('--learning_rate', type=float, default=1e-4)  # 4e-4 for xe, 4e-5 for rl
    ...
    parser.add_argument('--fc_feats', type=str, default='data/coco_resnet101/coco_fc.h5')
    parser.add_argument('--att_feats', type=str, default='data/coco_resnet101/coco_att.h5')
    ...
    #inference settings
    parser.add_argument('--inf_checkpoint', type=str, default='./checkpoint/xe/model.pth')
    parser.add_argument('--inf_captions', type=str, default='./data/captions/inf_captions.json')
    parser.add_argument('--inf_batch_size', type=int, default=20)

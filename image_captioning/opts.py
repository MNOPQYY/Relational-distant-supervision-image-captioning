...
def parse_opt():
    ...
    parser.add_argument('--fc_feats', type=str, default='../distant_supervision_construct/BUTD_model-master/data/coco_resnet101/coco_fc.h5')
    parser.add_argument('--att_feats', type=str, default='../distant_supervision_construct/BUTD_model-master/data/coco_resnet101/coco_att.h5')
